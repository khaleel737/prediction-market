...
import { getGeoBlockingSettingsFromSettings } from '@/lib/geo-blocking-settings'
...
export default async function AdminGeneralSettingsPage({ params }: AdminGeneralSettingsPageProps) {
  ...
  const initialGeoBlocking = getGeoBlockingSettingsFromSettings(allSettings ?? undefined)
  ...
  return (
    <section className="grid gap-4">
      ...
      <AdminGeneralSettingsForm
        ...
        initialGeoBlocking={initialGeoBlocking}
